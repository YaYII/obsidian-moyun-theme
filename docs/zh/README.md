> **这是墨韵的完整简体中文文档。** 英文主文档（社区目录要求）见 [README.md](../../README.md)。
>
> *This is the full Chinese documentation. The English README lives at [README.md](../../README.md).*
<div align="center">
...
2. Install the **Style Settings** community plugin to reach the theme's 37 settings.
...
```
36 个模块  →  node build.mjs  →  theme.css (237 KB)
```
